...
export declare class Float32Layer extends TileMapLayer<Float32Array> {
    constructor(name: string, provider: ITileContentProvider<Float32Array> | ITileDatasource<Float32Array, ITile2DAddress>, options?: ITileMapLayerOptions<Float32Array>, enabled?: boolean);
}
