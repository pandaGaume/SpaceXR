...
import { IContent, ITile3d, ITileset } from "core/tiles/3d/interfaces";
...
import { TilesetClient, ITile3dContentLoader, IUriResolver, TileContentStatus } from "core/tiles/3d/engine";
import { Nullable } from "core/types";

/** Augmentation for the engine */
declare module "core/tiles/3d/interfaces/content" {
    interface IContent {
