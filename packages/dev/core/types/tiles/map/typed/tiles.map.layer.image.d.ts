...
export declare class ImageLayer extends TileMapLayer<ImageLayerContentType> implements IImageTileMapLayer {
    constructor(name: string, provider: ITileContentProvider<ImageLayerContentType> | ITileDatasource<ImageLayerContentType, ITileAddress>, options?: IImageTileMapLayerOptions, enabled?: boolean);
