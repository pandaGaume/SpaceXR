...
import { IHasActivTiles, IHasNavigationState, ILinkOptions, IPipelineMessageType, ITargetBlock, ITile, ITileMapLayer, ITileMapLayerContainer, ITileMetrics, ITileMetricsProvider, ITileNavigationState, ITilePipelineLink, ITransformBlock } from "core/tiles";
...
import { IElevationMesh, IElevationTile } from "./map.elevation.mesh";
...
export declare class Map3dElevationHost extends TransformNode implements ITransformBlock<ITile<IDemInfos>, ITile<IElevationMesh>>, IHasActivTiles<IElevationMesh>, ITileMetricsProvider, IHasNavigationState {
    ...
    constructor(name: string, navigation: ITileNavigationState, layers: ITileMapLayerContainer<unknown, ITileMapLayer<unknown>>, source: ElevationLayer, enabled?: boolean);
    get navigation(): ITileNavigationState;
    get metrics(): ITileMetrics;
    get activTiles(): Array<Nullable<ITile<IElevationMesh>>>;
    ...
    linkTo(target: ITargetBlock<ITile<IElevationMesh>>, options?: ILinkOptions<IElevationMesh>): void;
