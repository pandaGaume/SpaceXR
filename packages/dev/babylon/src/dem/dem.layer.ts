...
import { ITile2DAddress, ITileContentFetcher, ITileDatasource, TileMapLayer } from "core/tiles";
...
export class ElevationLayer extends TileMapLayer<IDemInfos> implements IElevationLayer {
    ...
    public constructor(name: string, provider: ITileContentFetcher<IDemInfos> | ITileDatasource<IDemInfos, ITile2DAddress>, options?: IElevationLayerOptions, enabled?: boolean) {
