...
import { IDisplay, IHasDisplay } from "../../map";
import { IPipelineMessageType, ISourceBlock, ITargetBlock, SourceBlock } from "../../pipeline";
import { PriorityQueue } from "../../../collections";
import { WebClient } from "../../../io";
import { Ellipsoid } from "../../../geodesy";
import { Nullable } from "../../../types";
import { Observable, EventState } from "../../../events";
...
export class Tile3dStreamEngine extends SourceBlock<ITile3d> implements ITile3dStreamEngine {
    ...
    private _cartesianCache: ICartesian3[] = [Cartesian3.Zero()];
    ...
    protected async _process(): Promise<void> {
        ...
        try {
            ...
            for (const leaf of currentView.cut) {
                ...
                Cartesian3.ResetFromArray(tileCenter, leaf.worldBoundingVolume.sphere);
    ...
    protected _freeze(_leaf: ITile3d): void {}
    protected _unfreeze(_leaf: ITile3d): void {}
    ...
    protected _initializeTile(tile: ITile3d, parent?: ITile3d): void {
        ...
        if (tile.contents) {
            ...
            for (const c of tile.contents) {
                const uri = PathUtils.IsRelativeUrl(c.uri) ? PathUtils.ResolveUri(this._baseUri, c.uri) : c.uri;
                c.uri = uri;
    ...
    public updated(eventData: IPipelineMessageType<ITile3d>, _eventState: EventState): void {
