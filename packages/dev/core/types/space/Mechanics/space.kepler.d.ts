...
export declare class KeplerOrbitBase implements IKeplerOrbit {
    ...
    protected constructor(body: ICelestialBody, focus: ICelestialBody, semiMajorAxis: Length | number, eccentricity: number | undefined, periapsisTime: number | undefined, inclination: Angle | number, ascendingNodeLongitude: Angle | number, periapsisAngle: Angle | number, period: Timespan | number);
    get body(): ICelestialBody;
    get focus(): ICelestialBody;
    get semiMajorAxis(): Length;
    get semiMinorAxis(): Length;
    get periapsis(): Length;
