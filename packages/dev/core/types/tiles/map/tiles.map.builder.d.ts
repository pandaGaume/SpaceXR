...
import { ITileDisplayBounds, ITileMap, ITileMapBuilder, ITileMapLayer, ITileMapLayerBuilder } from "./tiles.map.interfaces";
export declare abstract class AbstractTileMapBuilder<T, L extends ITileMapLayer<T>> implements ITileMapBuilder<T, L> {
    ...
    withDisplay(display: ITileDisplayBounds): ITileMapBuilder<T, L>;
