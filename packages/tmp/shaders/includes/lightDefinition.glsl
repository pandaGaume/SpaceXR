...
vec3 calculatePointLight(PointLight light,
                            vec3 normal,// normalized normal at vertex or fragment
                            vec3 lightDir// raw light direction from vertex or fragment
                            #if defined(SPECULAR)
                            ,vec3 viewDir // normalized view direction from vertex or fragment
                            ,float shininess // shininess of the surface
                            #endif                
                        ) 
    {
...
// WARNING - Spot lights are not fully compatible with the BABYLON ones. The attenuation does not work in a similar way,
// and the underlying algorithm is different.
                    ...
                    ) 
{
    ...
    intensity = pow(intensity, 2.0) * attenuation; // smooth border
