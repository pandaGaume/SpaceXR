...
export class ImageLayerBuilder extends AbstractTileMapLayerBuilder<ImageLayerContentType, ImageLayer> {
    public constructor(name?: string, provider?: ITileProvider<ImageLayerContentType>) {
        super(name, provider);
    }

    public withOptions(options?: IImageTileMapLayerOptions): AbstractTileMapLayerBuilder<ImageLayerContentType, ImageLayer> {
    ...
    public build(): ImageLayer {
        ...
        const p = IsTileProviderBuilder<ImageLayerContentType>(this._provider) ? this._provider?.build() : this._provider;
