...
import { EPSG3857, Float32TileCodec, Float32TileCodecOptionsBuilder, IPixelDecoder, TileWebClient, WebTileUrlBuilder } from "core/tiles";
...
export const TerrainDemV1Client = function (token: string, options?: WebClientOptions) {
...
export const VectorClient = function (token: string, tileSetIds: string = MapBoxTileSetIds.Terrain, options?: WebClientOptions): TileWebClient<VectorTile> {
    const metrics = new EPSG3857({ maxLOD: MaxLevelOfDetail, tileSize: 256 });
