...
class VectorTileCodec {
    async decodeAsync(r) {
        ...
        if (r instanceof Response) {
            ...
            if (data) {
                const message = VectorTileCodec._messageDefinition.decode(new Uint8Array(await data.arrayBuffer()));
                return this._toVectorTileContent(message);
            }
        }
        return content;
    }
    _toVectorTileContent(mess) {
    ...
    _toVectorTileLayer(mess) {
        ...
        return {
            ...
            features: features,
            metadata: metadata,
            extent: new core_geometry__WEBPACK_IMPORTED_MODULE_1__.Size2(mess.extent, mess.extent),
        };
    }
    _toVectorTileFeature(mess) {
        const id = mess.id;
    ...
    _toPoint(mess) {
        return new core_geometry__WEBPACK_IMPORTED_MODULE_1__.Point(mess.geometry[0], mess.geometry[1]);
    }
    _toPolyline(mess) {
        const v = [];
